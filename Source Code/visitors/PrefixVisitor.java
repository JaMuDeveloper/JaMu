...
public class PrefixVisitor extends CustomVisitor {
	...
	public PrefixVisitor(CompilationUnit cu, String type, String fsymbol, String rsymbol, String label) {
		super(cu);
		setVisitorType(type);
	...
	public PrefixVisitor(CompilationUnit cu, String type, String fsymbol, String rsymbol) {
		super(cu);
		setVisitorType(type);
		symbolToFind = fsymbol;
		symbolToReplace = rsymbol;
